...
$scope.removedFromFavorites=true;$scope.favoritesResponse=response.status;$timeout(function(){$scope.removedFromFavorites=false;},1500);});}}]);App.factory('Socket',function($rootScope){'use strict';var _socket=null;return{emit:function(eventName,data){var emitData={};if(typeof data!=='undefined'){emitData={params:data};}
